      ...
      .col-lg-10(data-aos="fade-right")
        .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5
          ...
          .bloque-texto-g__texto.p-4
            p Es importante tener presente que la colocación del uniforme (batas) y los zapatos al momento se debe realizar en el momento de ingresar al área de trabajo y él retiró debe realizarse al fin de la jornada. 
            <br><br>
